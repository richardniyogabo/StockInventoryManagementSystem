...
<html>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"> Stock Inventory</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            ...
                                            Stock Inventory - Richard Developer
                        ...
                        <table>
                            ...
                            <tr> 
                                <td>
                                    ...
                                    <div class="form-group">
                                        <label for="mobile">Payment Amount(RWF)</label><br>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2023 <a href="#">Stock Inventory</a>.</strong> Richard
    </footer>
